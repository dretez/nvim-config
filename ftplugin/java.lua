...
-- [[ Minecraft ]]
vim.keymap.set('n', '<leader>Mb', '<cmd>!./gradlew build<cr>', { desc = '[M]inecraft: [b]uild project' })
vim.keymap.set('n', '<leader>Mr', '<cmd>!./gradlew runClient<cr>', { desc = '[M]inecraft: [r]un client' })
